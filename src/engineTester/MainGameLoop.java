...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		lights.add(new Light(new Vector3f(370, 17, -300), new Vector3f(0, 2, 2), new Vector3f(1, 5, 5f)));
		lights.add(new Light(new Vector3f(185, 10, -293), new Vector3f(2, 0, 0), new Vector3f(1, 0.01f, 0.002f)));
		Entity lampd = new Entity(lamp, new Vector3f(185, -4.7f, -293), 0, 0, 0, 1);
		lampd.getModel().getTexture().setUseFakeLighting(true);
		entities.add(lampd);
		...
		Player player = new Player(playerTexturedModel, new Vector3f(185, 5, -293), 0, 180, 0, 0.6f);
